...
static struct FScriptStruct_BlueprintAssist_StaticRegisterNativesFBAPackageData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBAPackageData>(FName(TEXT("BAPackageData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CacheVersion_MetaData[];
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_CacheVersion;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBAPackageData_Statics::NewProp_CacheVersion_MetaData[] = {
		{ "ModuleRelativePath", "Public/BlueprintAssistSizeCache.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FBAPackageData_Statics::NewProp_CacheVersion = { "CacheVersion", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBAPackageData, CacheVersion), METADATA_PARAMS(Z_Construct_UScriptStruct_FBAPackageData_Statics::NewProp_CacheVersion_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBAPackageData_Statics::NewProp_CacheVersion_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FBAPackageData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAPackageData_Statics::NewProp_CacheVersion,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FBAPackageData_Hash() { return 1679179352U; }
...
static struct FScriptStruct_BlueprintAssist_StaticRegisterNativesFBAGraphData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBAGraphData>(FName(TEXT("BAGraphData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBAGraphData_Hash() { return 885002946U; }
...
static struct FScriptStruct_BlueprintAssist_StaticRegisterNativesFBACacheData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBACacheData>(FName(TEXT("BACacheData")));
	}
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBACacheData_Statics::NewProp_CachedNodes_ValueProp = { "CachedNodes", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FBANodeData, METADATA_PARAMS(nullptr, 0) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FBACacheData_Hash() { return 3599659056U; }
class UScriptStruct* FBANodeData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern BLUEPRINTASSIST_API uint32 Get_Z_Construct_UScriptStruct_FBANodeData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FBANodeData, Z_Construct_UPackage__Script_BlueprintAssist(), TEXT("BANodeData"), sizeof(FBANodeData), Get_Z_Construct_UScriptStruct_FBANodeData_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FBANodeData(FBANodeData::StaticStruct, TEXT("/Script/BlueprintAssist"), TEXT("BANodeData"), false, nullptr, nullptr);
static struct FScriptStruct_BlueprintAssist_StaticRegisterNativesFBANodeData
{
	FScriptStruct_BlueprintAssist_StaticRegisterNativesFBANodeData()
	{
		UScriptStruct::DeferCppStructOps<FBANodeData>(FName(TEXT("BANodeData")));
	}
} ScriptStruct_BlueprintAssist_StaticRegisterNativesFBANodeData;
	struct Z_Construct_UScriptStruct_FBANodeData_Statics
	{
		...
		static void* NewStructOps();
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CachedNodeSize_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_CachedNodeSize;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBANodeData_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/BlueprintAssistSizeCache.h" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedNodeSize_MetaData[] = {
		{ "ModuleRelativePath", "Public/BlueprintAssistSizeCache.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedNodeSize = { "CachedNodeSize", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBANodeData, CachedNodeSize), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedNodeSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedNodeSize_MetaData)) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins_ValueProp = { "CachedPins", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins_Key_KeyProp = { "CachedPins_Key", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins_MetaData[] = {
		{ "ModuleRelativePath", "Public/BlueprintAssistSizeCache.h" },
	};
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins = { "CachedPins", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBANodeData, CachedPins), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FBANodeData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedNodeSize,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins_ValueProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins_Key_KeyProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBANodeData_Statics::NewProp_CachedPins,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FBANodeData_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_BlueprintAssist,
		nullptr,
		&NewStructOps,
		"BANodeData",
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FBANodeData_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_BlueprintAssist();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("BANodeData"), sizeof(FBANodeData), Get_Z_Construct_UScriptStruct_FBANodeData_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FBANodeData_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FBANodeData_Hash() { return 1850126482U; }
