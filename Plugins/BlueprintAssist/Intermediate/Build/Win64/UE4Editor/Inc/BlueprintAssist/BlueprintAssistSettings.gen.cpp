...
// End Cross Module References
	static UEnum* EBAFunctionAccessSpecifier_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_BlueprintAssist_EBAFunctionAccessSpecifier, Z_Construct_UPackage__Script_BlueprintAssist(), TEXT("EBAFunctionAccessSpecifier"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EBAFunctionAccessSpecifier(EBAFunctionAccessSpecifier_StaticEnum, TEXT("/Script/BlueprintAssist"), TEXT("EBAFunctionAccessSpecifier"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBAFunctionAccessSpecifier_Hash() { return 3027809677U; }
	UEnum* Z_Construct_UEnum_BlueprintAssist_EBAFunctionAccessSpecifier()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EBAFunctionAccessSpecifier"), 0, Get_Z_Construct_UEnum_BlueprintAssist_EBAFunctionAccessSpecifier_Hash(), false);
#else
	...
	static UEnum* EBAAutoZoomToNode_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_BlueprintAssist_EBAAutoZoomToNode, Z_Construct_UPackage__Script_BlueprintAssist(), TEXT("EBAAutoZoomToNode"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EBAAutoZoomToNode(EBAAutoZoomToNode_StaticEnum, TEXT("/Script/BlueprintAssist"), TEXT("EBAAutoZoomToNode"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBAAutoZoomToNode_Hash() { return 2383519331U; }
	UEnum* Z_Construct_UEnum_BlueprintAssist_EBAAutoZoomToNode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_BlueprintAssist();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EBAAutoZoomToNode"), 0, Get_Z_Construct_UEnum_BlueprintAssist_EBAAutoZoomToNode_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	static UEnum* EBAFormatterType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_BlueprintAssist_EBAFormatterType, Z_Construct_UPackage__Script_BlueprintAssist(), TEXT("EBAFormatterType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EBAFormatterType(EBAFormatterType_StaticEnum, TEXT("/Script/BlueprintAssist"), TEXT("EBAFormatterType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBAFormatterType_Hash() { return 3627861327U; }
	UEnum* Z_Construct_UEnum_BlueprintAssist_EBAFormatterType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_BlueprintAssist();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EBAFormatterType"), 0, Get_Z_Construct_UEnum_BlueprintAssist_EBAFormatterType_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBAFormatAllStyle_Hash() { return 2485955191U; }
	...
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBAAutoFormatting_Hash() { return 4216514211U; }
	...
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBAWiringStyle_Hash() { return 44944995U; }
	...
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBAParameterFormattingStyle_Hash() { return 2563372886U; }
	...
	uint32 Get_Z_Construct_UEnum_BlueprintAssist_EBANodeFormattingStyle_Hash() { return 2290300584U; }
...
static struct FScriptStruct_BlueprintAssist_StaticRegisterNativesFBAFormatterSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBAFormatterSettings>(FName(TEXT("BAFormatterSettings")));
	}
	...
	struct Z_Construct_UScriptStruct_FBAFormatterSettings_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_FormatterType_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FormatterType_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_FormatterType;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Padding_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_Padding;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_AutoFormatting_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AutoFormatting_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_AutoFormatting;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FormatterDirection_MetaData[];
#endif
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_FormatterDirection;
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_RootNodes_Inner;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ExecPinName_MetaData[];
#endif
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_ExecPinName;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterType_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterType = { "FormatterType", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBAFormatterSettings, FormatterType), Z_Construct_UEnum_BlueprintAssist_EBAFormatterType, METADATA_PARAMS(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_AutoFormatting = { "AutoFormatting", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBAFormatterSettings, AutoFormatting), Z_Construct_UEnum_BlueprintAssist_EBAAutoFormatting, METADATA_PARAMS(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_AutoFormatting_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_AutoFormatting_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterDirection_MetaData[] = {
		{ "Category", "FormatterSettings" },
		{ "ModuleRelativePath", "Public/BlueprintAssistSettings.h" },
	};
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterDirection = { "FormatterDirection", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBAFormatterSettings, FormatterDirection), Z_Construct_UEnum_Engine_EEdGraphPinDirection, METADATA_PARAMS(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterDirection_MetaData)) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_RootNodes_Inner = { "RootNodes", nullptr, (EPropertyFlags)0x0000000000004000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_RootNodes_MetaData[] = {
		{ "Category", "FormatterSettings" },
		{ "ModuleRelativePath", "Public/BlueprintAssistSettings.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_RootNodes = { "RootNodes", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBAFormatterSettings, RootNodes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_RootNodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_RootNodes_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_ExecPinName_MetaData[] = {
		{ "Category", "FormatterSettings" },
		{ "ModuleRelativePath", "Public/BlueprintAssistSettings.h" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_ExecPinName = { "ExecPinName", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBAFormatterSettings, ExecPinName), METADATA_PARAMS(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_ExecPinName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_ExecPinName_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_Padding,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_AutoFormatting_Underlying,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_FormatterDirection,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_RootNodes_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_RootNodes,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBAFormatterSettings_Statics::NewProp_ExecPinName,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FBAFormatterSettings_Hash() { return 1714566346U; }
	...
	struct Z_Construct_UClass_UBASettings_Statics
	{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableGlobalCommentBubblePinned_MetaData[];
#endif
		static void NewProp_bEnableGlobalCommentBubblePinned_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableGlobalCommentBubblePinned;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bGlobalCommentBubblePinnedValue_MetaData[];
#endif
		static void NewProp_bGlobalCommentBubblePinnedValue_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bGlobalCommentBubblePinnedValue;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAutoAddParentNode_MetaData[];
#endif
		static void NewProp_bAutoAddParentNode_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAutoAddParentNode;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAutoRenameGettersAndSetters_MetaData[];
#endif
		static void NewProp_bAutoRenameGettersAndSetters_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAutoRenameGettersAndSetters;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bMergeGenerateGetterAndSetterButton_MetaData[];
#endif
		static void NewProp_bMergeGenerateGetterAndSetterButton_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bMergeGenerateGetterAndSetterButton;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_AutoZoomToNodeBehavior_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AutoZoomToNodeBehavior_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_AutoZoomToNodeBehavior;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bGloballyDisableAutoFormatting_MetaData[];
#endif
		static void NewProp_bGloballyDisableAutoFormatting_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bGloballyDisableAutoFormatting;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_FormattingStyle_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FormattingStyle_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_FormattingStyle;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_ParameterStyle_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ParameterStyle_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_ParameterStyle;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_ExecutionWiringStyle_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ExecutionWiringStyle_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_ExecutionWiringStyle;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_ParameterWiringStyle_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ParameterWiringStyle_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_ParameterWiringStyle;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDetectNewNodesAndCacheNodeSizes_MetaData[];
#endif
		static void NewProp_bDetectNewNodesAndCacheNodeSizes_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDetectNewNodesAndCacheNodeSizes;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bRefreshNodeSizeBeforeFormatting_MetaData[];
#endif
		static void NewProp_bRefreshNodeSizeBeforeFormatting_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bRefreshNodeSizeBeforeFormatting;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bExpandNodesAheadOfParameters_MetaData[];
#endif
		static void NewProp_bExpandNodesAheadOfParameters_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bExpandNodesAheadOfParameters;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_FormatAllStyle_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FormatAllStyle_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_FormatAllStyle;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bCenterBranchesForParameters_MetaData[];
#endif
		static void NewProp_bCenterBranchesForParameters_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bCenterBranchesForParameters;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_NumRequiredBranchesForParameters_MetaData[];
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_NumRequiredBranchesForParameters;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_NonBlueprintFormatterSettings_ValueProp;
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_NonBlueprintFormatterSettings_Key_KeyProp;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_NonBlueprintFormatterSettings_MetaData[];
#endif
		static const UE4CodeGen_Private::FMapPropertyParams NewProp_NonBlueprintFormatterSettings;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bApplyCommentPadding_MetaData[];
#endif
		static void NewProp_bApplyCommentPadding_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bApplyCommentPadding;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableVariableDefaults_MetaData[];
#endif
		static void NewProp_bEnableVariableDefaults_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableVariableDefaults;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultVariableInstanceEditable_MetaData[];
#endif
		static void NewProp_bDefaultVariableInstanceEditable_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultVariableInstanceEditable;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultVariableBlueprintReadOnly_MetaData[];
#endif
		static void NewProp_bDefaultVariableBlueprintReadOnly_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultVariableBlueprintReadOnly;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultVariableExposeOnSpawn_MetaData[];
#endif
		static void NewProp_bDefaultVariableExposeOnSpawn_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultVariableExposeOnSpawn;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultVariablePrivate_MetaData[];
#endif
		static void NewProp_bDefaultVariablePrivate_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultVariablePrivate;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultVariableExposeToCinematics_MetaData[];
#endif
		static void NewProp_bDefaultVariableExposeToCinematics_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultVariableExposeToCinematics;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultVariableTooltip_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_DefaultVariableTooltip;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultVariableCategory_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_DefaultVariableCategory;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableFunctionDefaults_MetaData[];
#endif
		static void NewProp_bEnableFunctionDefaults_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableFunctionDefaults;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_DefaultFunctionAccessSpecifier_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultFunctionAccessSpecifier_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_DefaultFunctionAccessSpecifier;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultFunctionPure_MetaData[];
#endif
		static void NewProp_bDefaultFunctionPure_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultFunctionPure;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultFunctionConst_MetaData[];
#endif
		static void NewProp_bDefaultFunctionConst_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultFunctionConst;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDefaultFunctionExec_MetaData[];
#endif
		static void NewProp_bDefaultFunctionExec_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDefaultFunctionExec;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultFunctionTooltip_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_DefaultFunctionTooltip;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultFunctionKeywords_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_DefaultFunctionKeywords;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultFunctionCategory_MetaData[];
#endif
		static const UE4CodeGen_Private::FTextPropertyParams NewProp_DefaultFunctionCategory;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableInvisibleKnotNodes_MetaData[];
#endif
		static void NewProp_bEnableInvisibleKnotNodes_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableInvisibleKnotNodes;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bPlayLiveCompileSound_MetaData[];
#endif
		static void NewProp_bPlayLiveCompileSound_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bPlayLiveCompileSound;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableShiftDraggingNodes_MetaData[];
#endif
		static void NewProp_bEnableShiftDraggingNodes_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableShiftDraggingNodes;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableGlobalCommentBubblePinned_MetaData[] = {
		{ "Category", "General" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableGlobalCommentBubblePinned = { "bEnableGlobalCommentBubblePinned", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableGlobalCommentBubblePinned_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableGlobalCommentBubblePinned_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableGlobalCommentBubblePinned_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bGlobalCommentBubblePinnedValue_MetaData[] = {
		{ "Category", "General" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bGlobalCommentBubblePinnedValue = { "bGlobalCommentBubblePinnedValue", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bGlobalCommentBubblePinnedValue_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bGlobalCommentBubblePinnedValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bGlobalCommentBubblePinnedValue_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoAddParentNode_MetaData[] = {
		{ "Category", "General" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoAddParentNode = { "bAutoAddParentNode", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoAddParentNode_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoAddParentNode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoAddParentNode_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoRenameGettersAndSetters_MetaData[] = {
		{ "Category", "General" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoRenameGettersAndSetters = { "bAutoRenameGettersAndSetters", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoRenameGettersAndSetters_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoRenameGettersAndSetters_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoRenameGettersAndSetters_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bMergeGenerateGetterAndSetterButton_MetaData[] = {
		{ "Category", "General" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bMergeGenerateGetterAndSetterButton = { "bMergeGenerateGetterAndSetterButton", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bMergeGenerateGetterAndSetterButton_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bMergeGenerateGetterAndSetterButton_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bMergeGenerateGetterAndSetterButton_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_AutoZoomToNodeBehavior_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_AutoZoomToNodeBehavior_MetaData[] = {
		{ "Category", "General" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_AutoZoomToNodeBehavior = { "AutoZoomToNodeBehavior", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, AutoZoomToNodeBehavior), Z_Construct_UEnum_BlueprintAssist_EBAAutoZoomToNode, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_AutoZoomToNodeBehavior_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_AutoZoomToNodeBehavior_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bGloballyDisableAutoFormatting_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bGloballyDisableAutoFormatting = { "bGloballyDisableAutoFormatting", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bGloballyDisableAutoFormatting_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bGloballyDisableAutoFormatting_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bGloballyDisableAutoFormatting_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_FormattingStyle_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_FormattingStyle = { "FormattingStyle", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, FormattingStyle), Z_Construct_UEnum_BlueprintAssist_EBANodeFormattingStyle, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_FormattingStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_FormattingStyle_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterStyle_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterStyle = { "ParameterStyle", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, ParameterStyle), Z_Construct_UEnum_BlueprintAssist_EBAParameterFormattingStyle, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterStyle_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_ExecutionWiringStyle_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_ExecutionWiringStyle = { "ExecutionWiringStyle", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, ExecutionWiringStyle), Z_Construct_UEnum_BlueprintAssist_EBAWiringStyle, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_ExecutionWiringStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_ExecutionWiringStyle_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterWiringStyle_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterWiringStyle = { "ParameterWiringStyle", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, ParameterWiringStyle), Z_Construct_UEnum_BlueprintAssist_EBAWiringStyle, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterWiringStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterWiringStyle_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDetectNewNodesAndCacheNodeSizes_MetaData[] = {
		{ "Category", "FormattingOptions" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDetectNewNodesAndCacheNodeSizes = { "bDetectNewNodesAndCacheNodeSizes", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDetectNewNodesAndCacheNodeSizes_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDetectNewNodesAndCacheNodeSizes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDetectNewNodesAndCacheNodeSizes_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bRefreshNodeSizeBeforeFormatting_MetaData[] = {
		{ "Category", "FormattingOptions" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bRefreshNodeSizeBeforeFormatting = { "bRefreshNodeSizeBeforeFormatting", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bRefreshNodeSizeBeforeFormatting_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bRefreshNodeSizeBeforeFormatting_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bRefreshNodeSizeBeforeFormatting_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bExpandNodesAheadOfParameters_MetaData[] = {
		{ "Category", "FormattingOptions" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bExpandNodesAheadOfParameters = { "bExpandNodesAheadOfParameters", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bExpandNodesAheadOfParameters_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bExpandNodesAheadOfParameters_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bExpandNodesAheadOfParameters_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bSnapToGrid_MetaData[] = {
		{ "Category", "FormattingOptions" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bSnapToGrid = { "bSnapToGrid", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bSnapToGrid_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bSnapToGrid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bSnapToGrid_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_FormatAllStyle_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_FormatAllStyle = { "FormatAllStyle", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, FormatAllStyle), Z_Construct_UEnum_BlueprintAssist_EBAFormatAllStyle, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_FormatAllStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_FormatAllStyle_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_UseBlueprintFormattingForTheseGraphs = { "UseBlueprintFormattingForTheseGraphs", nullptr, (EPropertyFlags)0x0010040000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, UseBlueprintFormattingForTheseGraphs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_UseBlueprintFormattingForTheseGraphs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_UseBlueprintFormattingForTheseGraphs_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bCenterBranchesForParameters_MetaData[] = {
		{ "Category", "BlueprintFormatting" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bCenterBranchesForParameters = { "bCenterBranchesForParameters", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bCenterBranchesForParameters_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bCenterBranchesForParameters_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bCenterBranchesForParameters_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_NumRequiredBranchesForParameters_MetaData[] = {
		{ "Category", "BlueprintFormatting" },
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_NumRequiredBranchesForParameters = { "NumRequiredBranchesForParameters", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, NumRequiredBranchesForParameters), METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_NumRequiredBranchesForParameters_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_NumRequiredBranchesForParameters_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings_ValueProp = { "NonBlueprintFormatterSettings", nullptr, (EPropertyFlags)0x0000000000004001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FBAFormatterSettings, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings_Key_KeyProp = { "NonBlueprintFormatterSettings_Key", nullptr, (EPropertyFlags)0x0000000000004001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings = { "NonBlueprintFormatterSettings", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, NonBlueprintFormatterSettings), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bApplyCommentPadding_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bApplyCommentPadding = { "bApplyCommentPadding", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bApplyCommentPadding_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bApplyCommentPadding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bApplyCommentPadding_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableVariableDefaults_MetaData[] = {
		{ "Category", "New Variable Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableVariableDefaults = { "bEnableVariableDefaults", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableVariableDefaults_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableVariableDefaults_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableVariableDefaults_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableInstanceEditable_MetaData[] = {
		{ "Category", "New Variable Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableInstanceEditable = { "bDefaultVariableInstanceEditable", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableInstanceEditable_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableInstanceEditable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableInstanceEditable_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableBlueprintReadOnly_MetaData[] = {
		{ "Category", "New Variable Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableBlueprintReadOnly = { "bDefaultVariableBlueprintReadOnly", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableBlueprintReadOnly_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableBlueprintReadOnly_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableBlueprintReadOnly_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeOnSpawn_MetaData[] = {
		{ "Category", "New Variable Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeOnSpawn = { "bDefaultVariableExposeOnSpawn", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeOnSpawn_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeOnSpawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeOnSpawn_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariablePrivate_MetaData[] = {
		{ "Category", "New Variable Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariablePrivate = { "bDefaultVariablePrivate", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariablePrivate_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariablePrivate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariablePrivate_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeToCinematics_MetaData[] = {
		{ "Category", "New Variable Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeToCinematics = { "bDefaultVariableExposeToCinematics", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeToCinematics_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeToCinematics_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeToCinematics_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableTooltip_MetaData[] = {
		{ "Category", "New Variable Defaults" },
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableTooltip = { "DefaultVariableTooltip", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, DefaultVariableTooltip), METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableTooltip_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableTooltip_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableCategory_MetaData[] = {
		{ "Category", "New Variable Defaults" },
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableCategory = { "DefaultVariableCategory", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, DefaultVariableCategory), METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableCategory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableCategory_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableFunctionDefaults_MetaData[] = {
		{ "Category", "New Function Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableFunctionDefaults = { "bEnableFunctionDefaults", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableFunctionDefaults_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableFunctionDefaults_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableFunctionDefaults_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionAccessSpecifier_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionAccessSpecifier_MetaData[] = {
		{ "Category", "New Function Defaults" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionAccessSpecifier = { "DefaultFunctionAccessSpecifier", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, DefaultFunctionAccessSpecifier), Z_Construct_UEnum_BlueprintAssist_EBAFunctionAccessSpecifier, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionAccessSpecifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionAccessSpecifier_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionPure_MetaData[] = {
		{ "Category", "New Function Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionPure = { "bDefaultFunctionPure", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionPure_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionPure_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionPure_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionConst_MetaData[] = {
		{ "Category", "New Function Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionConst = { "bDefaultFunctionConst", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionConst_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionConst_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionConst_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionExec_MetaData[] = {
		{ "Category", "New Function Defaults" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionExec = { "bDefaultFunctionExec", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionExec_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionExec_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionExec_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionTooltip_MetaData[] = {
		{ "Category", "New Function Defaults" },
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionTooltip = { "DefaultFunctionTooltip", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, DefaultFunctionTooltip), METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionTooltip_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionTooltip_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionKeywords_MetaData[] = {
		{ "Category", "New Function Defaults" },
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionKeywords = { "DefaultFunctionKeywords", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, DefaultFunctionKeywords), METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionKeywords_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionKeywords_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionCategory_MetaData[] = {
		{ "Category", "New Function Defaults" },
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionCategory = { "DefaultFunctionCategory", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, DefaultFunctionCategory), METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionCategory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionCategory_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableInvisibleKnotNodes_MetaData[] = {
		{ "Category", "Misc" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableInvisibleKnotNodes = { "bEnableInvisibleKnotNodes", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableInvisibleKnotNodes_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableInvisibleKnotNodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableInvisibleKnotNodes_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bPlayLiveCompileSound_MetaData[] = {
		{ "Category", "Misc" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bPlayLiveCompileSound = { "bPlayLiveCompileSound", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bPlayLiveCompileSound_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bPlayLiveCompileSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bPlayLiveCompileSound_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableShiftDraggingNodes_MetaData[] = {
		{ "Category", "Misc" },
		{ "Comment", "/* Shift dragging a node will move all connected nodes */" },
		{ "ModuleRelativePath", "Public/BlueprintAssistSettings.h" },
		{ "ToolTip", "Shift dragging a node will move all connected nodes" },
	};
#endif
	void Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableShiftDraggingNodes_SetBit(void* Obj)
	{
		((UBASettings*)Obj)->bEnableShiftDraggingNodes = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableShiftDraggingNodes = { "bEnableShiftDraggingNodes", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBASettings), &Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableShiftDraggingNodes_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableShiftDraggingNodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableShiftDraggingNodes_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBASettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableGlobalCommentBubblePinned,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bGlobalCommentBubblePinnedValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bBetterWiringForNewNodes,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoAddParentNode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bAutoRenameGettersAndSetters,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bMergeGenerateGetterAndSetterButton,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_AutoZoomToNodeBehavior_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_AutoZoomToNodeBehavior,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bGloballyDisableAutoFormatting,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_FormattingStyle_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_FormattingStyle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterStyle_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterStyle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_ExecutionWiringStyle_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_ExecutionWiringStyle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_ParameterWiringStyle_Underlying,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDetectNewNodesAndCacheNodeSizes,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bRefreshNodeSizeBeforeFormatting,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bCreateKnotNodes,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bExpandNodesAheadOfParameters,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bSnapToGrid,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_FormatAllStyle_Underlying,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bCenterBranchesForParameters,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_NumRequiredBranchesForParameters,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings_ValueProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings_Key_KeyProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_NonBlueprintFormatterSettings,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bApplyCommentPadding,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableVariableDefaults,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableInstanceEditable,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableBlueprintReadOnly,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeOnSpawn,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariablePrivate,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultVariableExposeToCinematics,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableTooltip,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultVariableCategory,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableFunctionDefaults,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionAccessSpecifier_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionAccessSpecifier,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionPure,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionConst,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bDefaultFunctionExec,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionTooltip,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionKeywords,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_DefaultFunctionCategory,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableInvisibleKnotNodes,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bPlayLiveCompileSound,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_bEnableShiftDraggingNodes,
	...
	IMPLEMENT_CLASS(UBASettings, 3280093379);
