...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SelectDownStreamNodeForBothDirection_MetaData[];
#endif
		static void NewProp_SelectDownStreamNodeForBothDirection_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_SelectDownStreamNodeForBothDirection;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SelectStreamCutoffDistance_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SelectStreamCutoffDistance;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectDownStreamNodeForBothDirection_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Private/NodeGraphAssistantConfig.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectDownStreamNodeForBothDirection = { "SelectDownStreamNodeForBothDirection", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UNodeGraphAssistantConfig), &Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectDownStreamNodeForBothDirection_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectDownStreamNodeForBothDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectDownStreamNodeForBothDirection_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectStreamCutoffDistance_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Private/NodeGraphAssistantConfig.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectStreamCutoffDistance = { "SelectStreamCutoffDistance", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNodeGraphAssistantConfig, SelectStreamCutoffDistance), METADATA_PARAMS(Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectStreamCutoffDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectStreamCutoffDistance_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectDownStreamNodeForBothDirection,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNodeGraphAssistantConfig_Statics::NewProp_SelectStreamCutoffDistance,
	...
	IMPLEMENT_CLASS(UNodeGraphAssistantConfig, 2696421948);
